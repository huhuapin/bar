            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a class="collapse-link" href="{{url('type/create')}}">
                    ...
                    <table class="footable table table-stripped" data-page-size="8" data-filter=#filter>
                        ...
                        @foreach($types as $type)
                            <tr>
                                ...
                                <td><a href="{{url('type')}}/{{$type->id}}/edit"><i class="fa fa-edit text-navy"></i>
                                        编辑</a>
                                    <a href="{{url('type')}}/{{$type->id}}/delete"><i
                                                class="fa fa-close text-danger"></i> 删除</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
