        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal m-t" id="addForm" action="{{url('user')}}" method="post">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="checkbox-inline i-checks">
                                    <input type="radio" checked="" value="0" id="optionsRadios1"
                                           name="status">售货员</label>
                                <label class="checkbox-inline i-checks">
                                    <input type="radio" value="option2" id="optionsRadios2"
                                           name="optionsRadios">管理员</label>
                            </div>
                        </div>
                        <div class="form-group">
