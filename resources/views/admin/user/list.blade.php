                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="collapse-link" href="{{url('user/create')}}">
                                ...
                                <thead>
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>{{$user->tel}}</td>
                                            <td>{{$user->name}}</td>
                                            <td>{{$user->status == 0?'管理员':'售货员'}}</td>
                                            <td><a href="{{url('user')}}/{{$user->id}}/edit"><i class="fa fa-refresh text-navy"></i> 重置密码</a>
                                                <a href="{{url('user')}}/{{$user->id}}/delete"><i class="fa fa-close text-danger"></i> 删除</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
