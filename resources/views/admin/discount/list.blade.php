                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="collapse-link" href="{{url('discount/create')}}">
                                ...
                                <thead>
                                    ...
                                    @foreach($discounts as $discount)
                                        <tr>
                                            ...
                                            <td><a href="{{url('discount')}}/{{$discount->id}}/edit"><i class="fa fa-edit text-navy"></i> 修改</a>
                                                <a href="{{url('discount')}}/{{$discount->id}}/delete"><i class="fa fa-close text-danger"></i> 删除</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
