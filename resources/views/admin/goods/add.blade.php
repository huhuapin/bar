        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal m-t" enctype="multipart/form-data" id="addForm" action="{{url('goods')}}" method="post">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="remain" name="remain" class="form-control" type="number">
                            </div>
                        </div>
                        <div class="form-group">
